...
## 제1장: 상황 파악하기: 우리는 어디로 가는가, 여기는 어디인가
...
불필요하며unnecessary 매력적이지 않아요unattractive.
...
음식, 비건 식당)로 쓰는걸 추천한다고 해요. 명사는 이분법적 느낌(그래서 비건이야
아니야?)을 주는 반면, 형용사는 그러한 느낌을 덜 주기 때문입니다. "비건이 되라는
말(명사)"과 "비건 음식을 먹어보라(형용사)"는 말엔 큰 차이가 있습니다.
...
비영리-영리 이분법이 현실에 딱 맞지도 않습니다. 이러한 이분법보다는
재무우선-변화우선 연속체 상에서 어디에 무게를 더 둘지를 고민하는 방식이 더
유익합니다. 또는 유튜브, 블로그, 지역 식당 등 다양한 방법으로 수익을 만들며
변화에도 동참하는 방법도 있습니다.
...
비건 및 비거니즘이라는 단어는 도널드 왓슨과 도로시 왓슨 부부가 처음
고안했습니다. 이들이 제안한 비거니즘은 상당히 유연했습니다:
