...
[이분화](/terms/dichotomy.html)는 존재를 두개의 서로 대립되는 범주로 나누는 심적 과정이에요. 범주화 자체는 문제가 아니나 이분법은 세상에 대한 흑백논리적 관점을 만들기에 문제적입니다. 이분법적 사고는 부정확한 근거에 기반하여 세상을 경직되게 나누고, 양자에 다른 가치를 부여해요.
